...
public class PompeyLadGridLayoutActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new PompeyLadImageAdapter(PompeyLadGridLayoutActivity.this));
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                Intent i = new Intent(getApplicationContext(), PompeyLadFullScreenViewActivity.class);
                // passing array index
