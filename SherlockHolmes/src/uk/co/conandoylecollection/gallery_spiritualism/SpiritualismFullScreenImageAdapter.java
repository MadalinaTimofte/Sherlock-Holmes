...
public class SpiritualismFullScreenImageAdapter extends PagerAdapter {
	...
	public SpiritualismFullScreenImageAdapter(Activity context,Integer[] mThumbIds,String[] description,int _position){
	...
	public SpiritualismFullScreenImageAdapter(Activity context){
		this.context = context;
	}
	@Override
    public int getCount() {
