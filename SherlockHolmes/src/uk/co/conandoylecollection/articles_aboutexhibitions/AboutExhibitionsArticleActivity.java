...
import uk.co.conandoylecollection.articles_aboutexhibitions.FirstPageFragment;
...
public class AboutExhibitionsArticleActivity extends FragmentActivity {
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int pos) {
            ...
            case 0: return FirstPageFragment.newInstance("These online exhibitions form part of the Sharing Sherlock: The Story of a Pompey " +
            		"Lad (1)about Sir Arthur Conan Doyle (2). Based upon the touring exhibitions created " +
            		"with local schools and groups, this online exhibition provides a glimpse into the world " +
            		"of Sir Arthur Conan Doyle as portrayed in the Sir Arthur Conan Doyle collection (3) of " +
            		...
            		"Sherlock Holmes (4), when he published his first story A Study in Scarlet. \n\n" +
