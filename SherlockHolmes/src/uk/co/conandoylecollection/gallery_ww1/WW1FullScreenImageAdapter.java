...
public class WW1FullScreenImageAdapter extends PagerAdapter {
	...
	public WW1FullScreenImageAdapter(Activity context,Integer[] mThumbIds,String[] description,int _position){
	...
	public WW1FullScreenImageAdapter(Activity context){
		this.context = context;
	}
	@Override
    public int getCount() {
