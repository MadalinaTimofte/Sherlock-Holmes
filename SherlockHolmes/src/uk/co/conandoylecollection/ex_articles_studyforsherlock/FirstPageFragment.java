...
public class FirstPageFragment extends Fragment{
	 ...
	 @Override
	    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	        ...
	        title.setText("A Study For Sherlock");
	        ImageView imageview = (ImageView)v.findViewById(R.id.pager_image);
	        imageview.setImageResource(R.drawable.articles_studyforsherlock);
	        TextView web_link = (TextView) v.findViewById(R.id.web_link);
	        web_link.setText("http://www.conandoylecollection.co.uk/study-for-sherlock.html");
